...
class Player():
    ...
    def get_heuristic_value(board: Board):
        ...
        This heuristic focuses on preserving current pieces until the board begins
        to become restricted (defined by _PREPARE_TO_CENTER), in which case
        ...
        manhattan_dist_center_sum: int = 0
        ...
        if board.round_num > -Player._PREPARE_TO_CENTER:
            for white_square in white_squares:
                ...
                manhattan_dist_center_sum += manhattan_dist_center_avg/count
        ...
        if board.phase != GamePhase.PLACEMENT:
            return round(Player._WHITE_WEIGHT * num_white_pieces
                         ...
                         - Player._DIST_WEIGHT * manhattan_dist_center_sum,
