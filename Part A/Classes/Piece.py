...
class Piece:
    ...
    # This is a counter used to uniquely identify every instance of Piece in the game. This comes into play when a piece
    # jumps over an enemy piece. We want to ensure that the piece that ends up on the other side of the enemy piece is
    _id: int = 0
